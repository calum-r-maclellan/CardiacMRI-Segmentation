...
def parse_arguments():
    ...
    parser.add_argument('--batch_size',         type=int,       default=16,              help='number of images to pass through model per iteration')
    ...
    # Output directories
    parser.add_argument('--weights_path',       type=str,       default='/home/hsijcr/calummac/acdc/implementation/experiments/paper/model_checkpoints',   help='file location for storing results and model weights')
    ...
    parser.add_argument('--log_root',           type=str,       default='/home/hsijcr/calummac/acdc/implementation/experiments/paper/logs',                    help='root path for test.py to locate model weights')
    ...
    parser.add_argument('--val_track',          type=bool,      default=False,           help='choice to track acc of val epoch to save params')
