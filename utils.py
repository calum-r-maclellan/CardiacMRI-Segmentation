...
# function for splitting the training dataset into training and validation subsets.
# no need for shuffling since its already been done in the preprocess.py
